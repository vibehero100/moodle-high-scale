...
variable "environment_configuration" {
  ...
  default = {
    development = {
      azure_database_sku              = "Standard_D2ds_v5"
      azure_database_read_replica_sku = "Standard_D2ds_v5"
    ...
    production = {
      azure_database_sku              = "Standard_D32ds_v5"
      azure_database_read_replica_sku = "Standard_D32ds_v5"
